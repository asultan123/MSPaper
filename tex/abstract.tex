...
programming of HERO. Using the HERO accelerator TEMPlate Optimizer (TEMPO), this
thesis finds utilization optimal configurations for HERO. Additionally, a novel
...
a HERO layer compiler that converts arbitrary convolution and linear layers
