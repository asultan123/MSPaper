...
kernels are supported directly. What remains of the dataflow design space are the unroll factors for F
...
HERO template parameters from which a concrete accelerator instance can
...
section. The latency of executing a layer based on the template parameters
...
calculated based on how the template parameters tile the layer's weight tensor.
