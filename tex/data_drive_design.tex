...
Wheather or not a convolution layer's kernel size is supported directly has an effect on the assumed
...
and output matricies are transposed and reshaped. All reshape operations
discussed in this chapter add a dimention of size 1 to the data and they incur
...
memory can mask the latency of transposing matricies is left as part of future
...
IFmap pixels accross groups of PEs for (3, 3) kernel computations. The choice of
